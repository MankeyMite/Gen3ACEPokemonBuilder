...
static const u16 sTutorLearnsets[] =
{
    ...
    [SPECIES_VENUSAUR] = TUTOR(MOVE_SWORDS_DANCE)
                       ...
                       | TUTOR(MOVE_MIMIC)
                       | TUTOR(MOVE_SUBSTITUTE)
                       | TUTOR(MOVE_FRENZY_PLANT), // Added move tutor-exclusive move
    ...
    [SPECIES_CHARIZARD] = TUTOR(MOVE_MEGA_PUNCH)
                        ...
                        | TUTOR(MOVE_ROCK_SLIDE)
                        | TUTOR(MOVE_SUBSTITUTE)
                        | TUTOR(MOVE_BLAST_BURN), // Added move tutor-exclusive move
    ...
    [SPECIES_BLASTOISE] = TUTOR(MOVE_MEGA_PUNCH)
                        ...
                        | TUTOR(MOVE_MIMIC)
                        | TUTOR(MOVE_SUBSTITUTE)
                        | TUTOR(MOVE_HYDRO_CANNON), // Added move tutor-exclusive move
