...
[![Version](https://img.shields.io/badge/version-0.1.6--alpha-blue.svg)](https://github.com/yourusername/pkmn-ace-tool)
...
- **Multiple Export Formats**:
  ...
  - Raw hex data
  - .ek3 file export/import (compatible with PKHeX)
- **Retro Gen 3 Themed UI**: Beautiful interface inspired by Ruby, Sapphire, and Emerald
...
4. **Check legality**: The tool will indicate if your Pokémon should be legal
...
#### .ek3 Files
Encrypted Pokémon files compatible with PKHeX. Use this format to:
